    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            ...
            <div class="mt-4 md:mt-0">
                <a href="{{ route('admin.users.export', request()->query()) }}" class="inline-flex items-center px-4 py-2.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-all shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        @if($user->boisson_preferee)
                                            <div class="flex items-center mt-1">
                                                ...
                                                <span class="text-xs font-medium text-orange-600">{{ $user->boisson_preferee }}</span>
                                            </div>
                                        @else
                                            <div class="flex items-center mt-1">
                                                <span class="text-xs text-gray-400 italic">Pas de boisson</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
